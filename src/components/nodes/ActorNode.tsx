...
export function ActorNode({ data }: NodeProps) {
  return (
    <div className="relative w-[220px] rounded-lg bg-[#262626] border border-[#333] shadow-lg hover:border-purple-500/50 transition-colors">
      <div
      ...
      <div className="p-3">
        ...
        <div className="mt-2 flex items-center gap-1">
          <span className="text-[10px] px-1.5 py-0.5 rounded bg-purple-500/20 text-purple-300 uppercase tracking-wide font-medium">
            Actor
          </span>
          {data.scope === "external" && (
